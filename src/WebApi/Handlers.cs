...
public class Handlers
{
    ...
    private static async Task BotOnMessageReceived(ITelegramBotClient botClient, Message message)
    {
        ...
        // var flow = await database.GetAsync<RegistrationFlow>(message.Chat.Id.ToString());
        // var reply = flow.Handle(message.Text);
    ...
    private static async Task BotOnCallbackQueryReceived(ITelegramBotClient botClient, CallbackQuery callbackQuery)
    {
        await botClient.AnswerCallbackQueryAsync(
            ...
            text: $"Callback query showing {callbackQuery.Data}");
    ...
    {
        Log.Information($"Received inline result: {chosenInlineResult.ResultId}");
        return Task.CompletedTask;
    }

    private static Task UnknownUpdateHandlerAsync(ITelegramBotClient botClient, Update update)
    {
        Log.Information("Unknown update type: {@update.Type}", update.Type);
        return Task.CompletedTask;
    }
}